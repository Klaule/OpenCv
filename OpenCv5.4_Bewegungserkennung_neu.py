...
TEMP_VIDEO_PATH = '/home/klaule/Videos/temp/'  # Temporärer Ordner für alle Videos
CAT_VIDEO_PATH = '/home/klaule/Videos/cat/'   # Ordner für Videos mit Katze
NO_CAT_VIDEO_PATH = '/home/klaule/Videos/no_cat/'  # Ordner für Videos ohne Katze
...
def detect_cat(video_path):
    ...
    while cap.isOpened():
        ...
        # TensorFlow Lite Modell aufrufen
        ...
        for i in range(len(scores)):
            if scores[i] > 0.5 and "cat" in labels[int(classes[i])]:
                cat_detected = True
                break
