    ...
    try:
        ...
        if recording:
            try:
                ...
                print(f"Fehler beim Erfassen des Frames während der Aufnahme: {e}")
                picam2.stop()
                picam2.start()
                continue
            ...
            if not movement_detected:
                ...
                while post_recording_frames < (POST_RECORD_SECONDS * FRAMES_PER_SECOND):
                    try:
                        ...
                        print(f"Fehler beim Erfassen des Frames während der Nach-Aufnahme: {e}")
                        picam2.stop()
                        picam2.start()
                        break
        ...
        print(f"Fehler beim Erfassen des Frames: {e}")
        picam2.stop()
        picam2.start()
        continue
